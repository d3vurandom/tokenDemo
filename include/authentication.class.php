<?php
    ...
    class authentication{
         ...
         * @param $cookieName
         * @param $cookieValue
         * @return bool Returned true if the cookie was removed successfully
         */
        public function removeAuthenticationCookie($cookieName, $cookieValue){
            if(!isset($expire)){
                $expire = time(); //this will expire in in 0 seconds
            }
